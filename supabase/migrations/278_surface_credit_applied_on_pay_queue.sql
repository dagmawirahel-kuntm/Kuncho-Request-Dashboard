-- 278 — Make a credit-funded payable visible where it's actually paid
--
...
-- this is refused outright, the same stance already taken in 276 for
...
SELECT
  ...
  -- Same formula as v_credit_applicable_payables.cash_payable (277) —
