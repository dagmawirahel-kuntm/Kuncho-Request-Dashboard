-- 277 — Let a vendor credit fund a payable that has not been wired yet
--
...
--
-- Same distinction drawn for PO-2026-0102 in migration 276: a credit is a
-- means of payment, not a discount. 276 settled a delivered payable in
